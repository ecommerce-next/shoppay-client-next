    ...
    return (
        <div className={styles.shipping}>
                    ...
                    <div key={address._id} style={{position: "relative"}}>
                        ...
                        >
                            ...
                            <div className={styles.address__col}>
                                ...
                                <span><GiPhone/>{address.phoneNumber}</span>
                            </div>
                            <div className={styles.address__col}>
                                <span><FaMapMarkerAlt/>{address.address1}</span>
            ...
            <button className={styles.hide_show} onClick={() => setVisible(!visible)}>
                {visible ? (<span><IoMdArrowDropupCircle style={{fontSize: "2rem", fill: "#222"}}/></span>)
                    : (<span> ADD NEW ADDRESS <AiOutlinePlus/></span>)}
            </button>
