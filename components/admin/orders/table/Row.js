    ...
    return (
        <>
            <TableRow sx={{"& > *": {borderBottom: "unset"}}}>
                ...
                <TableCell align="right">{row.paymentMethod == "paypal" ? "Paypal" : "Credit Card"}</TableCell>
                            ...
                            <Table size="small" aria-label="purchases">
                                ...
                                <TableBody>
                                    ...
                                    <TableRow key={row._id}>
                                        ...
                                        <TableCell align="left"></TableCell>
                                        <TableCell align="left" style={{padding: "20px 0 20px 18px"}}><b
                                            style={{fontSize: "20px"}}>{row.total}$</b></TableCell>
                                    </TableRow>
                                </TableBody>
                            </Table>
                        </Box>
